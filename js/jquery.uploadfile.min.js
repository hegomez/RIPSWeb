...
! function(e) {
    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
        ...
        var w = e.extend({
            ...
            dragDropContainerClass: "input-group",
            dragDropHoverClass: "state-hover",
            errorClass: "ajax-file-upload-error",
            uploadButtonClass: "input-group-addon reset-other-btn",
        ...
        var C = this,
            b = e('<i class="fas fa-cloud-upload-alt"></i>');
        e(b).addClass(w.uploadButtonClass),
            function a() {
                if (e.fn.ajaxForm) {
                    if (w.dragDrop) {
                        var t = e('<div class="' + w.dragDropContainerClass + '" style=""></div>');
